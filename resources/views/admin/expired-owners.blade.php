    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="sm:p-6 py-6 bg-white border-b border-gray-200">
                    ...
                    <section class="text-gray-600 body-font">
                        ...
                        <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                            <div class="text-right p-6">
                                <x-form.button no="1" px="px-8" onclick="location.href='{{ route('admin.owners.create') }}'">新規作成する</x-form.button>
                             </div>
                          ...
                          <table class="table-auto w-full text-left whitespace-no-wrap">
                            <thead>
                              <tr>
                                ...
                                <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">削除日</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="md:px-4 py-3">
                                      ...
                                      <sapn class="text-xs text-gray-400">{{ $owner->deleted_at }}</span>
                                  </td>
                                  <td class="sm:px-4 py-3">
                                    <form action="{{ route('admin.expired-owners.destroy', $owner) }}" id="delete_{{ $owner->id }}" method="post" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <x-form.button type="button" no="caution" px="px-2 md:px-4" onclick="deleteSubmit(this)" data-id="{{ $owner->id }}">完全に削除</x-button>
                                    </form>
                                  </td>
                                </tr>
                                @endforeach
